...
const initState = { TemplateStore: { templates: {}, id: 1 } };

const setKeyValue = (key, value) => {
  const templates = initState.getIn(['TemplateStore']);
  return initState.mergeIn(
    ['TemplateStore'],
    templates.concat({ [key]: value }),
  );
};

describe('selectConfigValue()', () => {
  const state = setKeyValue('templates', {
    1: { content: 'hi ho', other: true },
  });
  ...
  describe('function', () => {
    it('value is set', () => {
      const configs = {
        title: ({ id }) => ['TemplateStore', 'templates', id, 'content'],
      };

      expect(selectConfigValue(configs)(state, { id: 1 })).toEqual({
        title: 'hi ho',
      });
    });
    ...
    it('value is undefined', () => {
      ...
      expect(selectConfigValue(configs)(state, { id: 2 })).toEqual({
        title: undefined,
      });
    ...
    it('keyPath is undefined', () => {
      const configs = {
        title: ({ id }) => ['TemplateStore', 'template', id, 'content'],
      };
  ...
  describe('array of strings', () => {
    it('keyPath exists', () => {
      ...
      expect(selectConfigValue(configs)(state)).toEqual({
        templates: { 1: { content: 'hi ho', other: true } },
      });
    });
  ...
  describe('selectIsLoading array of strings', () => {
    it('willLoad true', () => {
      const stating = setKeyValue('templates', {
        content: 'hi ho',
        willLoad: true,
      });
      const configs = { templates: ['TemplateStore', 'templates'] };
  ...
  describe('array, last element is function', () => {
    it('one keyPath, value is set', () => {
      ...
      expect(
        selectConfigValue(configs)(state, { id: 1, surfix: 'hehe' }),
      ).toEqual({ title: 'hi ho_hehe' });
    });

    it('2 keyPaths, value is set', () => {
      const configs = {
        title: {
          keyPath: [['TemplateStore', 'templates'], ['TemplateStore', 'id']],
          getter: (templates, id, { surfix }) =>
            `${templates[id].content}_${surfix}`,
        },
      };
      expect(selectConfigValue(configs)(state, { surfix: 'hehe' })).toEqual({
        title: 'hi ho_hehe',
      });
    });
    ...
    it('5 keyPaths, value is set', () => {
      const configs = {
        title: {
          ...
          getter: (templates, id1, id2, id3, id4, id5, { surfix }) =>
            `${templates[id1].content}_${surfix}_${id2}_${id3}_${id4}_${id5}`,
        },
      };
      expect(selectConfigValue(configs)(state, { surfix: 'hehe' })).toEqual({
        title: 'hi ho_hehe_1_1_1_1',
      });
    });
    ...
    it('value not set', () => {
      ...
      expect(selectConfigValue(configs)(ownState, {})).toEqual({
        title: undefined,
      });
    });
  });
  ...
  describe('object', () => {
    describe('keyPath', () => {
      describe('keyPath is function', () => {
        ...
        it('keyPath is undefined', () => {
          const configs = {
            title: {
              keyPath: ({ id }) => ['TemplateStore', 'template', id, 'content'],
            },
          };
          expect(selectConfigValue(configs)(state, { id: 1 })).toEqual({
            title: undefined,
      ...
      describe('keyPath is array of strings', () => {
        it('keyPath exists', () => {
          const configs = {
            templates: { keyPath: ['TemplateStore', 'templates'] },
          };
          expect(selectConfigValue(configs)(state)).toEqual({
            templates: { 1: { content: 'hi ho', other: true } },
          });
        ...
        it('keyPath undefined', () => {
          const configs = {
            templates: { keyPath: ['TemplateStore', 'template'] },
          };
          expect(selectConfigValue(configs)(state)).toEqual({
            templates: undefined,
          });
        ...
        it('keyPath undefined, notSetValue is set', () => {
          const configs = {
            templates: {
              keyPath: ['TemplateStore', 'template'],
              notSetValue: {},
            },
          };
      ...
      describe('keyPath is array of strings and functions', () => {
        ...
        it('2 keyPaths, value is set, no getter', () => {
          ...
          expect(selectConfigValue(configs)(state, {})).toEqual({
            title: { 1: { content: 'hi ho', other: true } },
          });
        });
        ...
        it('5 keyPaths, value is set', () => {
          const configs = {
            title: {
              ...
              getter: (templates, id1, id2, id3, id4, id5, { surfix }) =>
                `${
                  templates[id1].content
                }_${surfix}_${id2}_${id3}_${id4}_${id5}`,
            },
          };
          expect(selectConfigValue(configs)(state, { surfix: 'hehe' })).toEqual(
            { title: 'hi ho_hehe_1_1_1_1' },
    ...
    describe('spreadObject', () => {
      it('spreadObject is undefined', () => {
        const configs = {
          title: { keyPath: ({ id }) => ['TemplateStore', 'templates', id] },
        };
        expect(selectConfigValue(configs)(state, { id: 1 })).toEqual({
          title: { content: 'hi ho', other: true },
        });
      });
      ...
      it('spreadObject is false', () => {
        const configs = {
          title: {
            keyPath: ({ id }) => ['TemplateStore', 'templates', id],
            spreadObject: false,
          },
        };
        expect(selectConfigValue(configs)(state, { id: 1 })).toEqual({

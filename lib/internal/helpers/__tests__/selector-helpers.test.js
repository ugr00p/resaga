  ...
  describe('SELECTOR_UTILS', () => {
    describe('isKeyPath()', () => {
      ...
      it('should return true', () => {
        ...
        expect(SELECTOR_UTILS.isKeyPath(() => ['path', 'to', 'prop'])).toBe(
          true,
        );
      });
    });
    ...
    describe('isGetter()', () => {
      ...
      it('should return false', () => {
        SELECTOR_UTILS.isInvalidKeyPath = jest.fn(() => true);
        expect(SELECTOR_UTILS.isGetter({ getter: 'not a valid getter' })).toBe(
          false,
        );
      });
    });
    ...
    describe('isPropSelector()', () => {
      ...
      it('should return true', () => {
        ...
        expect(SELECTOR_UTILS.isPropSelector([() => 123, () => 456])).toBe(
          true,
        );
      });
    });
    ...
    describe('selectKeyPath()', () => {
      it('keyPath static isResagaStore false isLoading false', () => {
        ...
        expect(
          SELECTOR_UTILS.selectKeyPath(
            { keyPath: [1, 2, 3], notSetValue: 2233 },
            false,
          )(state, props),
        ).toBe('getIn');
      });
      ...
      it('keyPath function isResagaStore false isLoading true', () => {
        ...
        expect(
          SELECTOR_UTILS.selectKeyPath(
            { keyPath: ({ id }) => [id, 2], notSetValue: 2233 },
            true,
          )(state, props),
        ).toEqual(true);
      });
    ...
    describe('makeStateSelectors()', () => {
      it('should return selectKeyPath', () => {
        ...
        expect(SELECTOR_UTILS.makeStateSelectors()([], 123)).toEqual([
          'selectKeyPath',
        ]);
      });
    });
    ...
    describe('normaliseKeyPath()', () => {
      ...
      it('should return makeStateSelectors keyPath single', () => {
        SELECTOR_UTILS.makeStateSelectors = jest.fn(() => () =>
          'makeStateSelectors',
        );

        expect(SELECTOR_UTILS.normaliseKeyPath({ keyPath: [1] })).toBe(
          'makeStateSelectors',
        );
      });
    ...
    describe('customSelectProp()', () => {
      it('should return props', () => {
        expect(SELECTOR_UTILS.customSelectProp(props => props)(1, 222)).toBe(
          222,
        );
    ...
    describe('customSelectProps()', () => {
      it('should return customSelectProp array', () => {
        ...
        expect(SELECTOR_UTILS.customSelectProps([() => 1, () => 2])).toEqual([
          'customSelectProp',
          'customSelectProp',
        ]);
      });
      ...
      it('should return customSelectProp function', () => {
        ...
        expect(SELECTOR_UTILS.customSelectProps(() => 1)).toEqual([
          'customSelectProp',
        ]);
      });
    ...
    describe('normaliseProps()', () => {
      it('should return selectAllProps', () => {
        ...
        expect(SELECTOR_UTILS.normaliseProps({ getter: jest.fn() })).toBe(
          SELECTOR_UTILS.selectAllProps,
        );
      });
      ...
      it('should return customSelectProps', () => {
        ...
        expect(SELECTOR_UTILS.normaliseProps({ props: 1 })).toBe(
          'customSelectProps',
        );
      });
      ...
      it('should return selectEmptyProps', () => {
        ...
        expect(SELECTOR_UTILS.normaliseProps({ props: 1 })).toBe(
          SELECTOR_UTILS.selectEmptyProps,
        );
      });
    });
    ...
    describe('normaliseGetter()', () => {
      it('should return getter function', () => {
        expect(SELECTOR_UTILS.normaliseGetter(jest.fn(() => 'getter'))()).toBe(
          'getter',
        );
      });
    ...
    describe('customCacheKey()', () => {
      it('should return cacheKey function', () => {
        expect(SELECTOR_UTILS.customCacheKey(jest.fn(() => 'cacheKey'))()).toBe(
          'cacheKey',
        );
      });

      it('should return cacheKey string', () => {
        expect(SELECTOR_UTILS.customCacheKey('cacheKeyString')()).toBe(
          'cacheKeyString',
        );
      });
    });
    ...
    describe('normaliseCacheKey()', () => {
      ...
      it('should return defaultCacheKey', () => {
        ...
        expect(SELECTOR_UTILS.normaliseCacheKey()).toBe(
          SELECTOR_UTILS.defaultCacheKey,
        );
      });
    });
    ...
    describe('normaliseOptions()', () => {
      it('should return cacheKey', () => {
        expect(
          SELECTOR_UTILS.normaliseOptions({ cacheKey: 123 }),
        ).toMatchSnapshot();
      });
  ...
  describe('SELECTOR_HELPERS', () => {
    describe('normalise()', () => {
      ...
      it('should return getter undefined', () => {
        ...
        expect(SELECTOR_HELPERS.normalise({ getter: () => 123 })).toBe(
          undefined,
        );
      });
    });
    ...
    describe('mapKey()', () => {
      it('should wrap with key', () => {
        ...
        expect(
          SELECTOR_HELPERS.mapKey(false, 'id', { some: 'object' }),
        ).toEqual({ id: { some: 'object' } });
        expect(SELECTOR_HELPERS.mapKey(true, 'id', 123)).toEqual({ id: 123 });
      });

      it('should spread', () => {
        expect(SELECTOR_HELPERS.mapKey(true, 'id', { some: 'object' })).toEqual(
          { some: 'object' },
        );
      });
    });

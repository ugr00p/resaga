...
describe('getValuesChanged()', () => {
  ...
  describe('isValueChanged()', () => {
    ...
    it('compare object - isEqual', () => {
      ...
      expect(isValueChanged(a, { hi: 'hello', ho: 'hehe' }, false, true)).toBe(
        true,
      );
      expect(isValueChanged(a, { ho: 'hehe' }, false, true)).toBe(true);
      expect(
        isValueChanged({ ho: 'hehe', hi: 123 }, { ho: 'hehe' }, false, true),
      ).toBe(true);
  ...
  describe('getValuesChanged()', () => {
    ...
    it('some changes - object', () => {
      ...
      expect(getValuesChanged(currentProps, nextProps)).toEqual({
        hi: 'hello',
      });
    });
    ...
    it('own compare function - isEqual false', () => {
      ...
      expect(getValuesChanged(currentProps, nextProps, internalProps)).toEqual({
        hi: 'hello',
      });
    });
